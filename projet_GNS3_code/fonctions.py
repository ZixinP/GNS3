...
def ipv6_config(as_number,interface, igp, add_ipv6, dict,cost):  
    if igp == "OSPF":
...
def add_ipv6_config(as_number,inter_name,igp,add_ipv6,dict,router_id,dict_data,cost):
    ipv6_config(as_number,inter_name,igp,add_ipv6,dict,cost)
